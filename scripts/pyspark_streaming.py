...
checkpointLocation = "s3://stream-checkpointing-rohe/kinesisToRedshift/"
redshiftJdbcUrl = f"jdbc:redshift://redshift-cluster-1.cm0t1hdtl9yl.ap-south-1.redshift.amazonaws.com:5439/dev"
redshiftTable = "food_delivery_datamart.factOrders"
tempDir = "s3://redshift-temp-data-rohe/temp-data/streaming_temp/"
